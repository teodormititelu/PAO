...
public class MainJDBC {
    public static void main( String[] args ){
        ...
        AuditRepository auditRepo = AuditRepository.getInstance();
        auditRepo.createTable();

        AddressRepository addressRepo = AddressRepository.getInstance();
        addressRepo.createTable();
        ...
        while( !exit ) {
            ...
            switch (action) {
                ...
                case 1: {
                    ...
                    auditRepo.addAction( "Show restaurant details" );
                    break;
                }
                case 2: {
                    ...
                    auditRepo.addAction( "Show restaurant promotions" );
                    break;
                }
                case 3: {
                    ...
                    auditRepo.addAction( "Display product list" );
                    break;
                }
                case 4: {
                    ...
                    writeService.addJDBC( newCustomer.getAddress());
                    writeService.addJDBC( newCustomer);

                    System.out.println("Customer registered successfully!!");

                    auditRepo.addAction( "Regsiter customer" );
                    break;
                }
                case 5: {
                    ...
                    auditRepo.addAction( "Customer login" );
                    break;
                }
                case 6: {
                    ...
                    auditRepo.addAction( "Show customer details" );
                    break;
                }
                case 7: {
                    ...
                    if( services.checkOrder( orderedProducts, customer, SecuPub ) ) {
                        ...
                        writeService.addJDBC( order );
                    }

                    auditRepo.addAction( "Create order" );
                    break;
                }
                case 8: {
                    ...
                    auditRepo.addAction( "Show customer's order history");
                    break;
                }
            }
        }
